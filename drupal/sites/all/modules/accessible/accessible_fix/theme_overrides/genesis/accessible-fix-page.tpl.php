<?php
// $Id: accessible-fix-page.tpl.php,v 1.1 2010/05/09 19:17:23 johnbarclay Exp $
 ...
 */
?>
<body id="genesis-2b" <?php print $section_class; ?> <?php if ($accessibility->aria): ?> role="document"  <?php endif; ?> >
  <div id="container" class="<?php print $classes; ?>">

    <?php if ($accessibility->skip_nav): ?>
    <div id="skip-nav">
    ...
    <div id="header" class="clear-block" <?php if ($accessibility->aria): ?> role="banner"  <?php endif; ?>>
      ...
      <?php if ($search_box): ?>
        <div id="search-box" <?php if ($accessibility->aria): ?> role="search"  <?php endif; ?>><?php print $search_box; ?></div> <!-- /search box -->
      <?php endif; ?>
    ...
    <div id="columns"><div class="columns-inner clear-block">
      ...
      <div id="content-column"><div class="content-inner">
        ...
        <div id="main-content" <?php if ($accessibility->aria): ?> role="main"  <?php endif; ?>>
