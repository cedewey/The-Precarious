 ...
 */
?>
<!-- template accessible/accessible-fix/theme_overrides/bartik/accessible-fix-page.tpl.php template -->
<div id="page-wrapper"><div id="page">

  <div id="header"<?php if ($accessibility->aria):
    print ' role="banner"'; endif; ?>><div class="section clearfix">
    ...
    <?php if ($main_menu): ?>
      <div id="navigation"<?php if ($accessibility->aria):
        print ' role="navigation"'; endif; ?>><div class="section clearfix">
  ...
  <?php if ($messages): ?>
    <div id="messages"<?php if ($accessibility->aria):
      print ' role="complementary"'; endif; ?>><div class="section clearfix">
      <?php print $messages; ?>
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
    ...
    <div id="content" class="column"><div class="section">
      <?php if (@$page['highlight']): ?><div id="highlight"<?php if ($accessibility->aria):
        print ' role="complementary"'; endif; ?>><?php print render($page['highlight']); ?></div><?php endif; ?>
      <a id="main-content"></a>
      <div<?php if ($accessibility->aria): print ' role="main"'; endif; ?>>
        ...
        <?php if ($tabs): ?>
          <div class="tabs"<?php if ($accessibility->aria): print ' role="navigation"'; endif; ?>>
  ...
  <div id="footer-wrapper"<?php if ($accessibility->aria): print ' role="contentinfo"'; endif; ?>><div class="section">
